        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '16px' }}>
            <div style={{
              ...
              <Calculator width='60' height='60' color='white' />
        ...
        <div style={whiteCard}>
          <div style={{ marginBottom: '24px' }}>
            ...
            <div style={{
              ...
              {[
                { field: 'E1', label: 'E1 (Longitudinal Modulus)', placeholder: 'e.g., 181', unit: 'GPa' },
                { field: 'E2', label: 'E2 (Transverse Modulus)', placeholder: 'e.g., 25.3', unit: 'GPa' },
                { field: 'v12', label: 'v12 (Poisson\'s Ratio)', placeholder: 'e.g., 0.2', unit: '' },
                { field: 'G12', label: 'G12 (Shear Modulus)', placeholder: 'e.g., 30.7', unit: 'GPa' }
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            {[
              ...
              { field: 'thickness', label: 'Thickness Values (comma separated)', placeholder: 'e.g., 1, 2, 3, 1', unit: 'mm' }
            ].map(({ field, label, placeholder, unit }) => (
